...
fun DetailsScreen(
    ...
    Log.d("Akash detail", description.toString())
    Log.d("Akash detail", originalTitle.toString())
    Log.d("Akash detail", overview.toString())
    Log.d("Akash detail", voteAverage.toString())
